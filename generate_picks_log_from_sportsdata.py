...
def get_game_score(game, home_team, away_team):
    if game.get("HomeTeam") == home_team and game.get("AwayTeam") == away_team:
        return game.get("HomeTeamRuns"), game.get("AwayTeamRuns")
    return None, None
    ...
    while current <= SEASON_END:
        ...
        for game in odds_data:
            ...
            for g in scores_data:
                hs, as_ = get_game_score(g, home, away)
